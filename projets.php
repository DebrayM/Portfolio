...
<body>
    <?php
    $req = $db->query('SELECT title, description, picture, codeposition FROM projets WHERE pagehtml="Projets"');
    ...
    <section id="Projets">
        <div class="container-fluid">
            <div class="row min-vh-100">
                ...
                <div class="col-md-12 col-lg-9 pt-5">
                    <div class="row d-flex align-items-center justify-content-end pt-3">
                        <div class="col-lg-3 d-flex flex-column align-items-center justify-content-center">
                            ...
                            if ($data['codeposition'] == "projetsl1col1"){
                        ...
                        <?php
                            foreach($results as $data){
                            if ($data['codeposition'] == "projetsl1col2"){
                                echo "<img src='assets/uploads/". $data['picture']. "' alt='". $data['title']. "' class='img-fluid'>";
                                echo "<h4>". $data['title']. "</h4>";
                                echo "<p>". $data['description']. "</p>";
                            }
                        ...
                        <?php
                            foreach($results as $data){
                            if ($data['codeposition'] == "projetsl1col3"){
                                echo "<img src='assets/uploads/". $data['picture']. "' alt='". $data['title']. "' class='img-fluid'>";
                                echo "<h4>". $data['title']. "</h4>";
                                echo "<p>". $data['description']. "</p>";
                            }
                        ...
                        <?php
                            foreach($results as $data){
                            if ($data['codeposition'] == "projetsl1col4"){
                                echo "<img src='assets/uploads/". $data['picture']. "' alt='". $data['title']. "' class='img-fluid'>";
                                echo "<h4>". $data['title']. "</h4>";
                                echo "<p>". $data['description']. "</p>";
                            }
                    ...
                    <div class="row d-flex align-items-center justify-content-end pt-3">
                        ...
                        <?php
                            foreach($results as $data){
                            if ($data['codeposition'] == "projetsl2col1"){
                                echo "<img src='assets/uploads/". $data['picture']. "' alt='". $data['title']. "' class='img-fluid'>";
                                echo "<h4>". $data['title']. "</h4>";
                                echo "<p>". $data['description']. "</p>";
                            }
                        ...
                        <?php
                            foreach($results as $data){
                            if ($data['codeposition'] == "projetsl2col2"){
                                echo "<img src='assets/uploads/". $data['picture']. "' alt='". $data['title']. "' class='img-fluid'>";
                                echo "<h4>". $data['title']. "</h4>";
                                echo "<p>". $data['description']. "</p>";
                            }
                        ...
                        <?php
                            foreach($results as $data){
                            if ($data['codeposition'] == "projetsl2col3"){
                                echo "<img src='assets/uploads/". $data['picture']. "' alt='". $data['title']. "' class='img-fluid'>";
                                echo "<h4>". $data['title']. "</h4>";
                                echo "<p>". $data['description']. "</p>";
                            }
                        ...
                        <?php
                            foreach($results as $data){
                            if ($data['codeposition'] == "projetsl2col4"){
                                echo "<img src='assets/uploads/". $data['picture']. "' alt='". $data['title']. "' class='img-fluid'>";
                                echo "<h4>". $data['title']. "</h4>";
                                echo "<p>". $data['description']. "</p>";
                            }
                ...
                <div class="col-md-12 col-lg-1 sectprojets d-flex align-items-center justify-content-center p-0">
